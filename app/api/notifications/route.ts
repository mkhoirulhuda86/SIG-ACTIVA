...
export async function GET(request: NextRequest) {
  try {
    ...
    // 4. Check Fluktuasi — isolate failures so notifications endpoint stays up.
    try {
    ...
    } catch (fluktuasiError) {
      console.error('Notifications fluktuasi section failed:', fluktuasiError);
    }
